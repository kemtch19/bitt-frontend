...
export const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  return (
    <div
      className={`w-45 border-r border-gray-200 flex flex-col justify-between items-center max-sm:absolute top-0 bottom-0 z-20 bg-white ${
      ...
      <div className=" flex justify-between items-center w-full border-t-2 p-2 border-gray-200">
        <div className="flex gap-2 items-center">
          ...
          <div className="flex flex-col">
            <h3 className="font-bold text-[15px]">John Doe</h3>
