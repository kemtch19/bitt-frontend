        ...
        <div className="flex p-3 justify-center">
          <div className="border-2 border-gray-100 dark:border-gray-600 rounded-2xl p-2">
            <div className="flex items-center gap-2">
              ...
              <textarea
                className="input input-ghost w-sm h-7 rezize-none overflow-hidden bg-base-100 text-black focus:outline-none placeholder:text-[14px] dark:text-white placeholder:text-white"
                type="text"
